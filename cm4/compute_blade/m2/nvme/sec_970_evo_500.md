...
|-|-|-|-|-|-|-|-|
| Samsung 970 EVO | MZ-V7E500BW | 500GB | M.2 2280 | M | NVMe | YES | [PiB #67380](https://pibenchmarks.com/benchmark/67380/), JG (below) |

Product brief: [SSD 970 EVO NVMe® M.2 500GB](https://www.samsung.com/us/computing/memory-storage/solid-state-drives/ssd-970-evo-nvme-m2-500gb-mz-v7e500bw/)
...
```
root@default-pi:~# df -Th /dev/nvme0n1p1
...
```
root@default-pi:~# DEVICE_UNDER_TEST=/dev/nvme0n1p1 ./disk-benchmark.sh
