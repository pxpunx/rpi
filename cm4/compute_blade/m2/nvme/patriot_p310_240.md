...
Jobs: 4 (f=4): [R(4)][27.3%][r=400MiB/s][r=399 IOPS][eta 00m:08s]
Jobs: 4 (f=4): [R(4)][36.4%][r=399MiB/s][r=398 IOPS][eta 00m:07s]
Jobs: 4 (f=4): [R(4)][54.5%][r=398MiB/s][r=397 IOPS][eta 00m:05s] 
Jobs: 4 (f=4): [R(4)][63.6%][r=399MiB/s][r=399 IOPS][eta 00m:04s]
Jobs: 4 (f=4): [R(4)][72.7%][r=400MiB/s][r=400 IOPS][eta 00m:03s]
Jobs: 4 (f=4): [R(4)][81.8%][r=398MiB/s][r=398 IOPS][eta 00m:02s]
Jobs: 4 (f=4): [R(4)][90.9%][r=399MiB/s][r=398 IOPS][eta 00m:01s]
Jobs: 4 (f=4): [R(4)][100.0%][r=397MiB/s][r=397 IOPS][eta 00m:00s]
fio-rand-read-sequential: (groupid=0, jobs=4): err= 0: pid=603: Sat Feb 18 19:58:25 2023
  read: IOPS=398, BW=398MiB/s (418MB/s)(4234MiB/10628msec)
    slat (usec): min=118, max=5478, avg=420.90, stdev=691.82
    clat (msec): min=137, max=5633, avg=631.75, stdev=232.54
     lat (msec): min=140, max=5633, avg=632.17, stdev=232.27
    clat percentiles (msec):
     |  1.00th=[  159],  5.00th=[  284], 10.00th=[  477], 20.00th=[  535],
     | 30.00th=[  634], 40.00th=[  634], 50.00th=[  634], 60.00th=[  634],
     | 70.00th=[  642], 80.00th=[  642], 90.00th=[  776], 95.00th=[  919],
     | 99.00th=[ 1217], 99.50th=[ 1552], 99.90th=[ 3171], 99.95th=[ 4665],
     | 99.99th=[ 5604]
   bw (  KiB/s): min=178176, max=519647, per=97.63%, avg=398255.82, stdev=20753.24, samples=82
   iops        : min=  174, max=  506, avg=388.45, stdev=20.27, samples=82
  lat (msec)   : 250=4.04%, 500=10.34%, 750=74.00%, 1000=7.70%, 2000=3.64%
  lat (msec)   : >=2000=0.28%
  cpu          : usr=0.14%, sys=4.64%, ctx=4296, majf=0, minf=65642
  IO depths    : 1=0.1%, 2=0.2%, 4=0.4%, 8=0.8%, 16=1.5%, 32=3.0%, >=64=94.0%
     submit    : 0=0.0%, 4=100.0%, 8=0.0%, 16=0.0%, 32=0.0%, 64=0.0%, >=64=0.0%
     complete  : 0=0.0%, 4=99.9%, 8=0.0%, 16=0.0%, 32=0.0%, 64=0.1%, >=64=0.0%
     issued rwts: total=4234,0,0,0 short=0,0,0,0 dropped=0,0,0,0
     latency   : target=0, window=0, percentile=100.00%, depth=64

Run status group 0 (all jobs):
   READ: bw=398MiB/s (418MB/s), 398MiB/s-398MiB/s (418MB/s-418MB/s), io=4234MiB (4440MB), run=10628-10628msec

Disk stats (read/write):
  nvme0n1: ios=16581/185, merge=0/15, ticks=10012471/75317, in_queue=10089470, util=99.36%
...
Running iozone 1024K random read and write tests...
	...
	Run began: Sat Feb 18 19:58:25 2023
	...
	File stride size set to 17 * record size.
          ...
          102400    1024   354605   356933                     381159   358119                                                                
...
Running iozone 4K random read and write tests...
	...
	Run began: Sat Feb 18 19:58:27 2023
	...
	File stride size set to 17 * record size.
                                                              random    random     bkwd    record    stride                                    
              kB  reclen    write  rewrite    read    reread    read     write     read   rewrite      read   fwrite frewrite    fread  freread
          102400       4    48018    75934                      47648    70493                                                                
